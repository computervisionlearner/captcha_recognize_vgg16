...
#%% vgg16
  ...
  conv1_1 = _conv('conv1_1', images, 3, 1, 64,is_training)
  conv1_2 = _conv('conv1_2', conv1_1,3, 64,64,is_training)
  pool1 = _max_pool_2x2(conv1_2,'pool1',is_training)



  conv2_1 = _conv('conv2_1', pool1, 3,64,128,is_training)
  conv2_2 = _conv('conv2_2', conv2_1,3,128,128,is_training)
  pool2 = _max_pool_2x2(conv2_2, 'pool2',is_training)


  conv3_1 = _conv('conv3_1', pool2, 3, 128, 256,is_training)
  conv3_2 = _conv('conv3_2',conv3_1, 3, 256, 256,is_training)
  conv3_3 = _conv('conv3_3',conv3_2, 3, 256, 256,is_training)
  ...
  pool5 = _max_pool_2x2(conv5_3, 'pool5',is_training)  #(batch,2,10,128)
  ...
  with tf.variable_scope('local1') as scope14:
    ...
    reshape = tf.reshape(norm, [batch_size,-1])
...
#  correct_batch = tf.reduce_sum(tf.cast(correct_prediction, tf.int32), 1)
